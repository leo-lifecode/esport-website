...
import DataNew from "../data/LastestNew";
        ...
        <div className="w-full flex justify-center flex-col items-center bg-[#071626] lg:pt-[160px] md:pt-[96px] pt-[80px]">
            <div className="xl:w-[1170px] md:w-[688px] lg:w-[768px]">
                <div className="flex justify-center">
                    <h1 className="text-white text-[24px] font-bold relative after:absolute after:w-[50%] after:h-[5px] after:bg-[#00EEBD] after:-bottom-[20px] after:-skew-x-12 after:left-[28%] block">LastestNew</h1>
                </div>
